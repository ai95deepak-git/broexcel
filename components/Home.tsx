...
import { FileSpreadsheet, LayoutDashboard, FileText, Upload, Plus, ArrowRight, Database, TrendingUp, ShieldCheck, FileType, Image as ImageIcon, Cloud } from 'lucide-react';
...
const Home: React.FC<HomeProps> = ({ onNavigate, onUpload, onLoadSample, onLogin }) => {
      ...
      <div className="w-full max-w-7xl mx-auto p-6 md:p-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          ...
          <ActionCard
            ...
            desc="Log in to securely save your datasets and access them from any device."
